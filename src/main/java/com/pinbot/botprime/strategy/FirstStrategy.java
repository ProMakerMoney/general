...
public class FirstStrategy implements Strategy {
    ...
    // === Фиксированный риск на сделку (без наращивания депозита) ===
    ...
    /** Отложенный вход (qty считаем при активации от FIXED_RISK_USD) */
    ...
    public List<BacktestTrade> backtest(List<Bar> bars) {
        ...
        for (int i = 0; i < bars.size(); i++) {
            ...
            // === 1) Активировать отложенный вход на этом баре (по OPEN) — qty считаем от FIXED_RISK_USD ===
            ...
            if (entryDir != null) {
                ...
                if (entryIndex < bars.size()) {
                    ...
                    if (stop != null) {
                        ...
                        // Ставим pending: qty посчитаем при активации от FIXED_RISK_USD
    ...
    /** sizing с учётом фиксированного риска в USD */
